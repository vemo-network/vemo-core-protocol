...
contract DataRegistryV2 is IDynamic, IComposable, IDerivable, AccessControlUpgradeable,
  ...
  //                    DERIVABLE
  // ====================================================
  function derive(address underlyingCollection, uint256 underlyingTokenId, uint256 startTime, uint256 endTime, uint256 royaltyRate) public onDerivable returns (bool) {
