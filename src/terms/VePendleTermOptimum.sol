 ...
 */
contract VePendleTermOptimum is IExecutionTerm, UUPSUpgradeable, OwnableUpgradeable {
        ...
        view
    {
        ...
        if (!allowedActions[bytes24(abi.encodePacked(selector, bytes20(to)))]) revert NonWhitelistAction();
    }
